	...
	<tbody>
		...
		<?php foreach ($students as $student): ?>		
			<tr>
				...
				<td><?php echo $student['Student']['curso']; ?></td>
				<td>
					<div class="btn-toolbar">
						...
						<a href="../students/view/<?php echo $student['Student']['id'];?>" data-original-title="Visualizar" rel="tooltip" data-toggle="modal" data-placement="top" class="btn btn-primary btn-circle"><i class="fa fa-eye"></i></a>
							...
							<a href="#" data-original-title="Excluir" rel="tooltip" data-toggle="modal" data-placement="top" class="btn btn-danger btn-circle"><i class="fa fa-trash-o"></i></a>
